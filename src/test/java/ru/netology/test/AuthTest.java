...
class AuthTest {
    ...
    @Test
    @DisplayName("Success with active registered user")
    void successWithActiveRegisteredUser() {
    ...
    @Test
    @DisplayName("Error with wrong login")
    void errorWithWrongLogin() {
        var registeredUser = getRegisteredUser("active");
    ...
    @Test
    @DisplayName("Error with blocked user")
    void errorWithBlockedUser() {
